...
switch($app->request->url()) {
    ...
    case '/whoami' : 
        ...
        break;
    case '/search' : 
        $app->router->get('/search', [TaskController::class, 'search']);
        break;
    case '/people' : 
        $app->router->get('/people', [TaskController::class, 'people']);
        break;
    case '/knowledge' : 
        $app->router->get('/knowledge', [TaskController::class, 'knowledge']);
        break;
    case '/tools' : 
        $app->router->get('/tools', [TaskController::class, 'tools']);
        break;
    case '/gnome' : 
        $app->router->get('/gnome', [TaskController::class, 'gnome']);
        break;
}
